            ...
            <div className="card col-sm-6 p-3">
                ...
                <form action="">
                    ...
                    <div className="mb-2">
                        ...
                        <input type="text" required className="form-control bg-light btn-outline-secondary" placeholder="Rua Carol Belivet, 11" Copacabana-RJ value={Endereco} onChange={e => setEndereco(e.target.value)} />
                    </div>
                    <div className="mb-2">
                        <br></br>
